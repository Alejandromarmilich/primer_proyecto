    ...
    <footer id="footer-view" class="container-fluid">
      <div class="row p-5 bg-dark text-white"> 
        ...
        <div class="col-12 col-md-6 col-lg-3">
          ...
          <div class="mb-1 d-flex justify-content-center">
            <a class="text-white text-decoration-none" href="catalogo"
              >Catálogo</a
            >
          </div>
          <div class="mb-1 d-flex justify-content-center">
            <a class="text-white text-decoration-none" href="quienes_somos"
              >Quienes Somos</a
            >
          </div>
          <div class="mb-1 d-flex justify-content-center">
            <a class="text-white text-decoration-none" href="acerca_de"
              >Acerca de</a
            >
          </div>
        </div>
