...
<nav id="navbar-view" class="navbar navbar-expand-lg bg-body-green fixed-top">
  <div class="container-fluid">
    ...
    <?php else : ?>
      ...
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNologueado" aria-controls="navbarNologueado" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
