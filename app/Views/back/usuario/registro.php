...
<section id="registro" class="container my-5 m-md-auto p-md-5">
  <div class="container my-5 m-md-6 p-md-5">
    ...
    <form class="container row g-3 my-6">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <input type="password" class="form-control" id="inputPassword4" placeholder="Ingrese un contraseña segura entre 8-20 caractéres">
      </div>
      <div class="col-12">
      ...
      <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="inputCity" placeholder="Ingrese su ciudad">
      </div>
      <div class="col-md-4">
